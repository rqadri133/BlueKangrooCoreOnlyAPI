    ...
    public class BuyerActivityRepository : IBuyerActivityRepository 
    {
        ...
        public async Task<AppBuyerActivity> AddBuyerActivity(AppBuyerActivity activity)
        {
            if (db != null)
            {
                ...
                await db.AppBuyerActivity.AddAsync(activity);
        ...
        public async Task<List<AppBuyerActivity>> LoadAllBuyerActivities()
        {
            if (db != null)
            {
                ...
                var activities = await db.AppBuyerActivity.ToListAsync<AppBuyerActivity>();
                return activities;
        ...
        public async Task<int> DeleteBuyerActivityInfo(Guid? buyerActivityId)
        {
            ...
            if (db != null)
            {
                ...
                var acDel = await db.AppBuyerActivity.FirstOrDefaultAsync(p => p.AppBuyerActivityId == buyerActivityId);

                if (acDel != null)
                {
                    //Delete that post
                    db.AppBuyerActivity.Remove(acDel);
        ...
        public async Task<AppBuyerActivity> GetBuyerActivityInfo(Guid? activityInfo)
        {
            if (db != null)
            {
                ...
                var selActivity = await db.AppBuyerActivity.FirstOrDefaultAsync<AppBuyerActivity>(p => p.AppBuyerActivityId == activityInfo);
                return selActivity;
        ...
        public async Task<AppBuyerActivity> UpdateBuyerActivity(AppBuyerActivity activity)
        {
            ...
            {
                //Delete that post
                db.AppBuyerActivity.Update(activity);
